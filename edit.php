...
<div class="input-group"><scope class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></scope><input type="email" name="mail" class="form-control" value="<?php echo $row["email"];?>" required/></div>
<br/><div class="input-group"><scope class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></scope><input type="text" name="mobile"  class="form-control" value="<?php echo $row["mobile"];?>" required/></div>
<br/><button class="btn btn-success form-control" type="submit"><div class="glyphicon glyphicon-pencil"></div>   Update</button>
</form><br/>
